# -*- coding: utf-8 -*-
"""
Created on Sat Apr 27 11:18:21 2019

@author: hp
"""


#mnist keras tensorflow opencv 
...
Mnist = input_data.read_data_sets('letters', validation_size=0)



from mnist import MNIST

emnist_data = MNIST(path='caps', return_type='numpy')
